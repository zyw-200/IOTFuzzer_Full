...
#cp  "${FIRMWARE_DIR}/scratch/7/image_dir/etc/rc.d/rcS" "${IMAGE_DIR}/etc/rc.d/" ##tp link
#cp  -r "${FIRMWARE_DIR}/../qemu_mode/qemu/shared/kernelinfo/procinfo_generic" "${IMAGE_DIR}/FILE_LOAD/" ##tp link
