...
#gdb -q --args \
${AFL} \
${QEMU} -m 1G -monitor telnet:127.0.0.1:4444,server -mem-prealloc -mem-path /home/zyw/tmp/afl_user_mode/image7/mem_file -M ${QEMU_MACHINE} -kernel ${KERNEL} \
...
#../qemu_mode/qemu/qemu-img convert -f raw -O qcow2 ./scratch/7/image.raw ./scratch/7/image.qcow2
