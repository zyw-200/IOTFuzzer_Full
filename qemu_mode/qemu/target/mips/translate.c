...
target_ulong defined_helper_aflCall(CPUArchState *env, target_ulong code, target_ulong a0, target_ulong a1) {
    ...
    switch(code) {
    case 1: {printf("startforkserver, env:%x,a0:%d ok\n",env,a0); return startForkserver(env, a0);}
    case 2: {printf("getWork, env:%x,a0:%d,a1:%d ok\n",env,a0,a1); return getWork(env, a0, a1);}
    case 3: {printf("startWork, env:%x,a0:%d ok\n",env, a0); return startWork(env, a0);}
    case 4: {printf("a0:%d ok\n",); return doneWork(a0);}
...
void helper_aflInterceptLog(CPUArchState *env)
{
    ...
    target_ulong stack = env->active_tc.gpr[29]; //zyw mips
